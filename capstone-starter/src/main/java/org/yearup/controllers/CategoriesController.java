 ...
 @Autowired
  public CategoriesController (CategoryDao categoryDao,ProductDao productDao){
    ...
    public ResponseEntity<Category> addCategory(@Valid @RequestBody Category category){
     boolean addCategory=categoryDao.create(category);
     if(addCategory){
    ...
    boolean update = categoryDao.update( category_id ,category);
     if(update){
    ...
    public ResponseEntity<Void> deleteCategory(@PathVariable int category_id) {
     ...
     boolean deletedSuccessfully=categoryDao.delete(category_id);
